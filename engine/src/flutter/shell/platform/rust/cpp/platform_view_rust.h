...
#ifndef FLUTTER_SHELL_PLATFORM_RUST_CPP_PLATFORM_VIEW_RUST_H_
#define FLUTTER_SHELL_PLATFORM_RUST_CPP_PLATFORM_VIEW_RUST_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_RUST_CPP_PLATFORM_VIEW_RUST_H_
