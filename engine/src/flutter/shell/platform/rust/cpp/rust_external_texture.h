...
#ifndef FLUTTER_SHELL_PLATFORM_RUST_RUST_EXTERNAL_TEXTURE_H_
#define FLUTTER_SHELL_PLATFORM_RUST_RUST_EXTERNAL_TEXTURE_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_RUST_RUST_EXTERNAL_TEXTURE_H_
